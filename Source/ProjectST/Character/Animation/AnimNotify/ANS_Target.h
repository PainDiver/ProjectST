...
public:
	...
	bool OnTargetFound(const TArray<FHitResult>& OtherActors,UANS_ScratchPad* InterestedScratchPad,AActor* Subject,UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
};
