...
클라가 Standalone에서 연결할 단독 C# Server 구현 및 DB구현
<br>

클라,C#서버 패킷생성 및 사용로직 자동화 (protoBuf 및 UStruct 코드자동생성)
<br>

Azure로 C#서버 띄운 후 클라 매칭요청 시 데디인스턴스 실행 후 클라에게 데디케이트서버 접속유도 그 이후 인게임
<br>
