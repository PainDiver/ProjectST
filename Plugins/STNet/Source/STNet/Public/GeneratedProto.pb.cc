...
PROTOBUF_CONSTINIT const uint32_t EPacketType_internal_data_[] = {
    131072u, 0u, };
...
inline PROTOBUF_NDEBUG_INLINE MyMessage::Impl_::Impl_(
    ...
    const Impl_& from, const ::MyMessage& from_msg)
...
inline void MyMessage::SharedDtor(MessageLite& self) {
  MyMessage& this_ = static_cast<MyMessage&>(self);
...
inline void* MyMessage::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) MyMessage(arena);
}
constexpr auto MyMessage::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(MyMessage),
                                            alignof(MyMessage));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull MyMessage::_class_data_ = {
...
const ::google::protobuf::internal::ClassData* MyMessage::GetClassData() const {
